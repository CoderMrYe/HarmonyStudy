package com.codermrye.test.adapter;

import com.codermrye.test.adapter.base.ItemViewDelegate;
import com.codermrye.test.adapter.base.ItemViewDelegateManager;
 ...
 * @param <T> generic
 */
public abstract class MultiItemTypeAdapter<T> extends RecycleItemProvider {
    List<T> dataList;
