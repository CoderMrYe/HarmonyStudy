package com.codermrye.test.slice;

import com.codermrye.test.ResourceTable;
import com.codermrye.test.adapter.CommonAdapter;
import com.codermrye.test.adapter.ViewHolder;
import com.codermrye.test.base.BaseAbilitySlice;
import com.codermrye.test.butterknife.Bind;
import com.codermrye.test.model.ProductList;
import com.codermrye.test.util.MediaUtil;
    ...
    private void initListener() {
        listContainer.setItemClickedListener((listContainer1, component, i, l) -> {
            ...
            Operation operation = new Intent.OperationBuilder()
                    ...
                    .withAbilityName("com.codermrye.test.MainAbility")
